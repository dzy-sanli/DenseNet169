...
from model import Loss,PretrainedDensenet,PretrainedDensenet_one
...
PATH = "./Dense_net_MURA_one.pth"
model_ft = train(criterion=criterion,optimizer=optimizer, model=model, n_epochs=100,
